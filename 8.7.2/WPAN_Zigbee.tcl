...
set tracefd     [open WPAN_Zigbee.tr w]
$ns_ trace-all $tracefd
if { "$val(nam)" == "WPAN_Zigbee.nam" } {
...
proc stop {} {
    ...
    if { ("$val(nam)" == "WPAN_Zigbee.nam") && ("$hasDISPLAY" == "1") } {
    	exec nam WPAN_Zigbee.nam &
    }
}
